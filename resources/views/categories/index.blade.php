...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <a href="{{ route('categories.create') }}" enctype="multipart/form-data" type="button"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger"
                                            onclick="showDeleteConfirmation('delete-category-{{ $item->id }}'); { document.getElementById('delete-category-{{ $item->id }}').submit() }"><i
