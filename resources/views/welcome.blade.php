        ...
        <section id="services" class="services">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <h2>Layanan Kami</h2>
                    <p>Kami menyediakan berbagai layanan perawatan sepatu dan sandal untuk setiap kebutuhan Anda.</p>
                </div>
            ...
            <div class="container">
                ...
                <div class="row portfolio-container">
                    @foreach ($data as $index => $item)
                        <div class="col-lg-4 col-md-6 portfolio-item filter-{{ $item->service_id }}">
                            <div class="portfolio-img"><img src="{{ asset($item->image_file_url) }}"
